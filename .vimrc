...
" Code reviews
"------------------------------------------------------------------------------
" - open file to be reviewed in window #1
" - open code-review file in window #2
" - in file window, ",sp" will mark the file and line#
" - switch to code-review file and ",ic" will create an file/line# entry for making a comment
function SavePosition()
    let g:file_name=expand("%:t")
    let g:line_number=line(".")
    let g:reviewer_initials="DPT"
endfunction
...
nmap ,ts a<C-R>=strftime("%Y/%m/%d: ")<CR>
imap ,ts <C-R>=strftime("%Y/%m/%d: ")<CR>
